...
const Contact = () => {
  ...
  return (
    <section
      id="contact"
      className="section-padding bg-gradient-to-b from-dark-700 to-dark-800 overflow-hidden"
    >
      <div className="container mx-auto">
        ...
        >
          ...
          <p className="text-gray-400 mt-6 max-w-3xl mx-auto">
            Open to collaborations or chats! Feel free to reach out if you have
